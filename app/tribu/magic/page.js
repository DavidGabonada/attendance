...
const MagicList = () => {
    ...
    // Filtering logic
    const filteredMagics = sampleData
        .filter((magic) =>
            magic.name.toLowerCase().includes(searchTerm.toLowerCase())
        )
        .filter((magic) =>
            filterYearLevel ? magic.yearLevel === filterYearLevel : true
        );
    ...
    return (
        <div
            style={{
                ...
                backgroundImage: 'url(/images/blue.webp)', // Set your background image here
