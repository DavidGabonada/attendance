...
const MagicList = () => {
    ...
    const [filteredMagics, setFilteredMagics] = useState([]);
    ...
    useEffect(() => {
        const filteredMagic = names.filter((magic) => Number(magic.student_yrId) === Number(filterYearLevel));
        setFilteredMagics(filteredMagic);
    }, [filterYearLevel]);
