...
const MageList = () => {
  ...
  const filteredMages = sampleData
    .filter((mage) =>
      mage.name.toLowerCase().includes(searchTerm.toLowerCase())
    )
    .filter((mage) =>
      filterYearLevel ? mage.yearLevel === filterYearLevel : true
    );
  ...
  return (
    <div
      style={{
        ...
        backgroundImage: 'url(/images/light.jpg)', // Set your background image here
