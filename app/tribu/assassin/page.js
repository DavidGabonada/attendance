...
const AssassinList = () => {
    ...
    const [filteredAssassins, setFilteredAssassins] = useState([]);
    ...
    useEffect(() => {
        const filteredAssassin = names.filter((assassin) => Number(assassin.student_yrId) === Number(filterYearLevel));
        setFilteredAssassins(filteredAssassin);
    }, [filterYearLevel])
